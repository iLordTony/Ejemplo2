...
public class AlbumDetailActivity extends ActionBarActivity implements SendDataDialogFragment.DialogListener {
    public static final String ALBUM_TYPE = "Tipo de Album";
    public static final String ALBUM_TITLE = "Nombre del Album";
